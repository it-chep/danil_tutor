...
import (
	...
	"github.com/it-chep/danil_tutor.git/internal/module/admin/action/auth/check_path_permission"
	"github.com/it-chep/danil_tutor.git/internal/module/admin/action/auth/get_user_info"
	"github.com/it-chep/danil_tutor.git/internal/module/admin/action/auth/login"
	"github.com/it-chep/danil_tutor.git/internal/module/admin/action/auth/logout"
	"github.com/it-chep/danil_tutor.git/internal/module/admin/action/auth/refresh"
	"github.com/it-chep/danil_tutor.git/internal/module/admin/action/auth/register"
