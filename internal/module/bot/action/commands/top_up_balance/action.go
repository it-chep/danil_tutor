...
import (
	...
	top_up_balance_dal "github.com/it-chep/danil_tutor.git/internal/module/bot/action/commands/top_up_balance/dal"
	...
	"github.com/it-chep/danil_tutor.git/internal/pkg/tg_bot/bot_dto"
...
func (a *Action) regOrderTbank(ctx context.Context, msg dto.Message, adminID int64, tx *business.Transaction, amount int) (orderID, url string, _ error) {
	...
	orderID, url, err = a.tbank.InitPayment(ctx, tbankDto.NewInitRequest(adminID, tx.ID, int64(amount), phone))
	if err != nil {
