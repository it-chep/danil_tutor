...
import (
	...
	"github.com/it-chep/danil_tutor.git/internal/server/handler/handler/admin/admins/create_admin"
	"github.com/it-chep/danil_tutor.git/internal/server/handler/handler/admin/admins/delete_admin"
	"github.com/it-chep/danil_tutor.git/internal/server/handler/handler/admin/admins/get_admin_by_id"
	"github.com/it-chep/danil_tutor.git/internal/server/handler/handler/admin/admins/get_admins"
)
