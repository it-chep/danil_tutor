...
import (
	...
	"github.com/it-chep/danil_tutor.git/internal/server/handler/handler/admin/tutor/conduct_lesson"
	"github.com/it-chep/danil_tutor.git/internal/server/handler/handler/admin/tutor/conduct_trial"
	"github.com/it-chep/danil_tutor.git/internal/server/handler/handler/admin/tutor/create_tutor"
	"github.com/it-chep/danil_tutor.git/internal/server/handler/handler/admin/tutor/delete_tutor"
	"github.com/it-chep/danil_tutor.git/internal/server/handler/handler/admin/tutor/get_lessons"
	"github.com/it-chep/danil_tutor.git/internal/server/handler/handler/admin/tutor/get_tutor_finance"
	"github.com/it-chep/danil_tutor.git/internal/server/handler/handler/admin/tutor/get_tutors"
	"github.com/it-chep/danil_tutor.git/internal/server/handler/handler/admin/tutor/search_tutor"
	"github.com/it-chep/danil_tutor.git/internal/server/handler/handler/admin/tutor/tutor_by_id"
)
