...
import (
	...
	"github.com/it-chep/danil_tutor.git/internal/module/admin/tbank"
	"github.com/it-chep/danil_tutor.git/internal/server/handler/handler/admin/admins"
	"github.com/it-chep/danil_tutor.git/internal/server/handler/handler/admin/get_all_finance"
	"github.com/it-chep/danil_tutor.git/internal/server/handler/handler/admin/get_all_lessons"
	"github.com/it-chep/danil_tutor.git/internal/server/handler/handler/admin/get_all_subjects"
	"github.com/it-chep/danil_tutor.git/internal/server/handler/handler/admin/get_all_transactions"
	"github.com/it-chep/danil_tutor.git/internal/server/handler/handler/admin/lessons"
	"github.com/it-chep/danil_tutor.git/internal/server/handler/handler/admin/student"
	"github.com/it-chep/danil_tutor.git/internal/server/handler/handler/admin/tutor"
)
